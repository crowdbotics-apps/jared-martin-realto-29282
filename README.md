...
## Project Structure
    ...
    ├── jared_martin_realto_29282  # Django project configurations
...
1. Clone this repo and `cd jared_martin_realto_29282`
...
2. Clone this repo and `cd jared_martin_realto_29282`
